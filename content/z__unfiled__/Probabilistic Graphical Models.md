...
* A variant of this is a **factor graph** which is a [[Bipartite Graph|bipartite]] where nodes are either variables or **factors** and edges connect between a variable and a factor.
