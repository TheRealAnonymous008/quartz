...
* **[Flow Fields](https://www.youtube.com/watch?v=1R7W8LVvegk)** - an approach where an entire [[Vector Field]] is pre-computed. The vectors in this field indicate the direction that agents should move towards. 
